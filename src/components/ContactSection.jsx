...
export const ContactSection = () => {
    ...
    const handleSubmit = (e) => {
        ...
        setTimeout(() => {
            notifySuccess("Message Sent!", "Thank you for your message. I'll get back to you soon.");
    ...
    <section id="contact" className="py-24 px-4 relative bg-secondary/30">
        <div className="container mx-auto max-w-5xl">
            ...
            <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
                Have a project or want to collaborate? Don't hesitate to contact us.
                    ...
                    <div className="space-y-6 justify-center">
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <a 
                                    href="alfinalfinican27@gmail.com" 
                                    className="text-muted-foreground hover:text-primary transition-colors"
                                > 
                                    alfinalfinican27@gmail.com
                                </a>
                            </div>
                        </div>
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <a 
                                    href="https://web.whatsapp.com/085641995098" 
                                    className="text-muted-foreground hover:text-primary transition-colors"
                                > 
                                    +62 856 4199 5098 ( Alfin )
                                </a>
                            </div>
                        </div>
                        <div className="flex items-start space-x-4">
